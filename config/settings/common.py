...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'carros.contrib.sites.migrations'
}
...
#ACCOUNT_SIGNUP_FORM_CLASS = 'alertas.forms.AlertForm'
ACCOUNT_AUTHENTICATION_METHOD = 'username'
ACCOUNT_EMAIL_REQUIRED = True
ACCOUNT_EMAIL_VERIFICATION = 'none'

ACCOUNT_ALLOW_REGISTRATION = env.bool('DJANGO_ACCOUNT_ALLOW_REGISTRATION', True)
ACCOUNT_ADAPTER = 'carros.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'carros.users.adapters.SocialAccountAdapter'
...
########## CELERY
INSTALLED_APPS += ('carros.taskapp.celery.CeleryConfig',)
